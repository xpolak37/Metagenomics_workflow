...
def merge(aaastrIn, ostm, gtdb, column_type):
    """
    ...
    for f in aaastrIn:
        ...
        profiles_list.append(pd.Series(data=iIn[column_type], index=iIn.index,
...
argp.add_argument('--col_type', default="relative_abundance",help=("Specifice which type of column you want to merge the - abundance profiles (use relative_abundance) or estimated counts (use estimated_number_of_reads_from_the_clade)"))
